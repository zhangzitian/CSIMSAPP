...
import com.zitian.csims.model.BookrevisionForkliftList;
...
import com.zitian.csims.ui.adapter.BookrevisionForkliftListAdapter;
...
public class BookrevisionForkliftListActivity  extends BaseActivity implements  View.OnClickListener, HttpListener<String> {

    private ImageView icon_back;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bookrevision_forklift_list);
    ...
    private void initView() {
        ...
        mDataAdapter = new BookrevisionForkliftListAdapter(this);
        ...
        mLRecyclerViewAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                if (mDataAdapter.getDataList().size() > position) {
                    BookrevisionForkliftList.Bean item = mDataAdapter.getDataList().get(position);
    ...
    private BookrevisionForkliftListAdapter mDataAdapter = null;
    ...
    {
        String condition =  "[t_taskType] = '图书改版下架' and t_taskState = '未领取' ";
        //if(!search_edit.getText().toString().equals("") )
        //{
        //    String prodNo = search_edit.getText().toString();
        //    condition += " and [t_prodNo] =  '" + prodNo + "'";
        //}
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.BookrevisionForkliftList(), RequestMethod.POST);
    ...
    private void DataBind2(int id,boolean isLoading) {
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.BookrevisionForkliftList2(), RequestMethod.POST);
        SENDSMSRequest.addHeader("token", "79FAF822-7194-4FE3-8C4F-1D99BE71BC9C");
    ...
    private void addItems(List<BookrevisionForkliftList.Bean> list) {
    ...
    public void onSucceed(int what, Response<String> response) {
        ...
        switch (what) {
            case 1000://快速登录
                BookrevisionForkliftList outofSpaceForkliftList = gson.fromJson(response.get(), BookrevisionForkliftList.class);
                ...
                break;
            case 1001://快速登录
                outofSpaceForkliftList = gson.fromJson(response.get(), BookrevisionForkliftList.class);
                if (outofSpaceForkliftList.getResult() == 1) {
                    ...
                    Toast.makeText(BookrevisionForkliftListActivity.this,outofSpaceForkliftList.getMsg(),Toast.LENGTH_SHORT).show();
                }else
                {
                    Toast.makeText(BookrevisionForkliftListActivity.this,outofSpaceForkliftList.getMsg(),Toast.LENGTH_SHORT).show();
                }
    ...
    private BookrevisionForkliftList.Bean itemModel = null;
    private int pos = 0;
    /**
     * item＋item里的控件点击监听事件
     */
    private BookrevisionForkliftListAdapter.OnItemClickListener MyItemClickListener = new BookrevisionForkliftListAdapter.OnItemClickListener() {

        @Override
        public void onItemClick(View v, BookrevisionForkliftListAdapter.ViewName viewName, int position) {
            ...
            switch (v.getId()){
                case R.id.tv_fromNoAndArea:
                    ...
                    mBundle.putString("sourceType","改版下架纠错");

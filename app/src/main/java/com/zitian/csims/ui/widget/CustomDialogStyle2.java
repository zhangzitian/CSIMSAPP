...
public class CustomDialogStyle2  extends Dialog {

    public CustomDialogStyle2(Context context) {
        super(context);
    }

    public CustomDialogStyle2(Context context, int themeResId) {
        super(context, themeResId);
    }

    protected CustomDialogStyle2(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    public static class Builder {
        ...
        public CustomDialogStyle2.Builder setTitle(String title) {
            if (title == null) {
                this.title = "提醒";
            }
            this.title = title;
        ...
        public CustomDialogStyle2.Builder setMessage(String message) {
            if (message == null) {
        ...
        public CustomDialogStyle2.Builder setNegativeButton(String negative_text, DialogInterface.OnClickListener negativeListener) {
        ...
        public CustomDialogStyle2.Builder setPositionButton(String positive_text, DialogInterface.OnClickListener positiveListener) {
        ...
        public CustomDialogStyle2 create() {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.dialog_style_layout2, null);

...
public class ManualShelvesListAdapter extends ListBaseAdapter<ManualShelvesList.Bean>  implements View.OnClickListener{

    public ManualShelvesListAdapter(Context context) {
        super(context);
    }

    @Override
    public int getLayoutId() {
        return R.layout.activity_manual_shelves_list_item;
    }

    @Override
    public void onBindItemHolder(SuperViewHolder holder, int position) {
        ManualShelvesList.Bean item = mDataList.get(position);
        ...
        btnOperation.setOnClickListener(ManualShelvesListAdapter.this);
    ...
    public interface OnItemClickListener  {
        void onItemClick(View v, ManualShelvesListAdapter.ViewName viewName, int position);
        void onItemLongClick(View v);
    }
    private ManualShelvesListAdapter.OnItemClickListener mOnItemClickListener;//声明自定义的接口
    //定义方法并传给外面的使用者
    public void setOnItemClickListener(ManualShelvesListAdapter.OnItemClickListener listener) {
    ...
    public void onClick(View v) {
        ...
        if (mOnItemClickListener != null) {
            switch (v.getId()){
                default:
                    mOnItemClickListener.onItemClick(v, ManualShelvesListAdapter.ViewName.ITEM, position);
                    break;
            }
        }
    }

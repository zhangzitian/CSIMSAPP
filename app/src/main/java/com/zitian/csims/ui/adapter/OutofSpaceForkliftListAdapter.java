...
public class OutofSpaceForkliftListAdapter extends ListBaseAdapter<OutofSpaceForkliftList.Bean>  implements View.OnClickListener{

    public OutofSpaceForkliftListAdapter(Context context) {
        super(context);
    }

    @Override
    public int getLayoutId() {
        return R.layout.activity_outof_space_forklift_list_item;
    }

    @Override
    public void onBindItemHolder(SuperViewHolder holder, int position) {
        OutofSpaceForkliftList.Bean item = mDataList.get(position);
        ...
        title3.setOnClickListener(OutofSpaceForkliftListAdapter.this);
        title4.setOnClickListener(OutofSpaceForkliftListAdapter.this);
        ...
        btnGain.setOnClickListener(OutofSpaceForkliftListAdapter.this);
        btnOperation.setOnClickListener(OutofSpaceForkliftListAdapter.this);

...
public class ManualShelvesWarehouseOutActivity extends BaseActivity implements  View.OnClickListener, HttpListener<String> {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manual_shelves_warehouse_out);
    ...
    private void DataBind(boolean isLoading)
    {
        ...
        SENDSMSRequest.add("a_type", "出库调整单");

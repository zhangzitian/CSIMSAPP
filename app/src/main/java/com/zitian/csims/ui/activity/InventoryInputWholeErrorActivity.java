...
public class InventoryInputWholeErrorActivity extends BaseActivity implements  View.OnClickListener, HttpListener<String> {
    ...
    InventoryInputWhole.Bean  itemModel;
    ...
    private void initView() {
        ...
        mDataAdapter = new InventoryInputWholeErrorAdapter(this);
        ...
        mLRecyclerViewAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                if (mDataAdapter.getDataList().size() > position) {
                    InventoryInputWholeError.Bean item = mDataAdapter.getDataList().get(position);
    ...
    private void DataBind2(boolean isLoading) {
        Gson gson = new Gson();
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.InventoryInputWholeError(), RequestMethod.POST);
    ...
    private void DataBind3(boolean isLoading) {
        Gson gson = new Gson();
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.GetInventoryInputWholeError(), RequestMethod.POST);
        SENDSMSRequest.addHeader("token", "79FAF822-7194-4FE3-8C4F-1D99BE71BC9C");
        SENDSMSRequest.add("sEcho", "1");
        SENDSMSRequest.add("UserName", CSIMSApplication.getAppContext().getUser().getO_name());
        SENDSMSRequest.add("UserId", CSIMSApplication.getAppContext().getUser().getO_id());
    ...
    private InventoryInputWholeErrorAdapter mDataAdapter = null;
    ...
    private void addItems(List<InventoryInputWholeError.Bean> list) {
    ...
    public void onSucceed(int what, Response<String> response) {
        ...
        switch (what) {
            case 1000://快速登录
                ...
                break;
//            case 1001://快速登录
//                InventoryInputWholeError outofSpaceForkliftList2 = gson.fromJson(response.get(), InventoryInputWholeError.class);
...
//                break;
            case 1001://快速登录
                ...
                break;
            case 1002://快速登录
                InventoryInputWholeError inventoryInputWholeError = gson.fromJson(response.get(), InventoryInputWholeError.class);
                if (inventoryInputWholeError.getResult() == 1) {
                    //List<InventoryInputWholeError.Bean> list = new ArrayList<>();
                    list = inventoryInputWholeError.getData();
                    DataBind();
                }else
                {
                    CreateCustomDialogStyle();
                    //ToastUtil.show(this, inventoryInputWholeError.getMsg());
                }
                break;
        }
    }
     ...
     * item＋item里的控件点击监听事件
     */
    private InventoryInputWholeErrorAdapter.OnItemClickListener MyItemClickListener = new InventoryInputWholeErrorAdapter.OnItemClickListener() {
        @Override
        public void onItemClick(View v, InventoryInputWholeErrorAdapter.ViewName viewName, int position) {
            ...
            switch (v.getId()) {
                case R.id.btnGain:
                    ...
                    InventoryInputWholeError.Bean  itemModel = mDataAdapter.getDataList().get(position);
                    //itemModel.id = 100;
    ...
    {
        builder = new CustomDialogStyle3.Builder(InventoryInputWholeErrorActivity.this);
            ...
            //.setNbook_num(list.size()!=0 ? "" : String.valueOf(itemModel.getWh_nbook_num()))
                ...
                .setPositionButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        {
                            Toast.makeText(InventoryInputWholeErrorActivity.this,"产品编码不能为空！",Toast.LENGTH_SHORT).show();
                            return;
                        }
    ...
    public void UpdateCustomDialogStyle(InventoryInputWholeError.Bean bean,int pos)
    {
        builder = new CustomDialogStyle3.Builder(InventoryInputWholeErrorActivity.this);
        builder.setTitle("库位号:"+itemModel.getWh_wareHouseNo())
                //.setMessage("请输入产品编码")

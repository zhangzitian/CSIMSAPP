...
public class InventoryEmptyErrorActivity extends BaseActivity implements  View.OnClickListener, HttpListener<String> {
    ...
    InventoryEmptyError.Bean itemModel;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inventory_input_whole_error);
        mCurrentPage = 0;
        initView();
        setViewListener();
        //DataBind3(wareHouseNo, true);
    ...
    private void initView() {
        ...
        //itemModel = (InventoryInputWhole.Bean) bundle.get("itemModel");
        wareHouseNo = (String) bundle.get("wareHouseNo");
        prodNo.setText("库位号："+wareHouseNo);
    ...
    private void DataBind2(boolean isLoading) {
        Gson gson = new Gson();
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.InventoryEmptyError2(), RequestMethod.POST);
    ...
    {
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.InventoryEmptyError(), RequestMethod.POST);
        SENDSMSRequest.addHeader("token", "79FAF822-7194-4FE3-8C4F-1D99BE71BC9C");
        SENDSMSRequest.add("sEcho", "1");
        SENDSMSRequest.add("wareHouseNo",wareHouseNo);
        SENDSMSRequest.add("condition"," [wh_wareHouseNo] = '"  + wareHouseNo + "'");
        SENDSMSRequest.add("UserId", CSIMSApplication.getAppContext().getUser().getO_id());
        SENDSMSRequest.add("UserName", CSIMSApplication.getAppContext().getUser().getO_name());
        ...
        switch (what) {
            ...
            case 1001://快速登录
                ...
                if (warehousingInDistributionQualityInput.getResult() == 1) {
                    ...
                    String result = wareHouseNo.toString().trim();
            ...
            case 1002://快速登录
                ...
                {
                    ToastUtil.show(this, inventoryEmptyError.getMsg());
                }
                break;
        }
    }
    ...
    {
        builder = new CustomDialogStyle3.Builder(InventoryEmptyErrorActivity.this);
        builder.setTitle("库位号:"+itemModel.getWh_wareHouseNo())
                ...
                .setNbox_num(list.size()!=0 ? "" : String.valueOf(itemModel.getWh_nbox_num()))
                .setNpack_num(list.size()!=0 ? "" : String.valueOf(itemModel.getWh_npack_num()))
                .setNbook_num(list.size()!=0 ? "" : String.valueOf(itemModel.getWh_nbook_num()))
                ...
                .setPositionButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        {
                            Toast.makeText(InventoryEmptyErrorActivity.this,"产品编码不能为空！",Toast.LENGTH_SHORT).show();
                            return;
                        }

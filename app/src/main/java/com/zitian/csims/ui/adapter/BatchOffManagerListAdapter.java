...
public class BatchOffManagerListAdapter extends ListBaseAdapter<BatchOffManagerList.Bean>  implements View.OnClickListener{

    public BatchOffManagerListAdapter(Context context) {
        super(context);
    }

    @Override
    public int getLayoutId() {
        return R.layout.activity_batch_off_manager_list_item;
    }

    @Override
    public void onBindItemHolder(SuperViewHolder holder, int position) {
        BatchOffManagerList.Bean item = mDataList.get(position);
        ...
        TextView title1 = holder.getView(R.id.tv_receiver);
        title1.setText("领取人：" + item.getReceiverName());
        ...
        title5.setText("");
        //title5.setText("托盘性质：" + item.getT_trayType());

        //title3.setOnClickListener(BatchOffManagerListAdapter.this);
        //title4.setOnClickListener(BatchOffManagerListAdapter.this);
        ...
        btnGain.setOnClickListener(BatchOffManagerListAdapter.this);
        btnOperation.setOnClickListener(BatchOffManagerListAdapter.this);
    ...
    public interface OnItemClickListener  {
        void onItemClick(View v, BatchOffManagerListAdapter.ViewName viewName, int position);
        void onItemLongClick(View v);
    }
    private BatchOffManagerListAdapter.OnItemClickListener mOnItemClickListener;//声明自定义的接口
    //定义方法并传给外面的使用者
    public void setOnItemClickListener(BatchOffManagerListAdapter.OnItemClickListener listener) {
    ...
    public void onClick(View v) {
        ...
        if (mOnItemClickListener != null) {
            switch (v.getId()){
                default:
                    mOnItemClickListener.onItemClick(v, BatchOffManagerListAdapter.ViewName.ITEM, position);
                    break;
            }
        }
    }

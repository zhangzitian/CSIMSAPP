...
public class ManualForkliftDowActivity  extends BaseActivity implements  View.OnClickListener, HttpListener<String> {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manual_forklift_dow);
    ...
    {
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.ManualForkliftDowActivity(), RequestMethod.POST);
        ...
        switch (what) {
            case 1000://快速登录
                ...
                if (outofSpaceForkliftList.getResult() == 1) {
                    ...
                    Intent intent = new Intent(ManualForkliftDowActivity.this,ManualForkliftListActivity.class);

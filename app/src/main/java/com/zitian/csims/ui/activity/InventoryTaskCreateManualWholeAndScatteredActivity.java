...
public class InventoryTaskCreateManualWholeAndScatteredActivity  extends BaseActivity implements  View.OnClickListener, HttpListener<String> {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inventory_task_create_manual_whole_and_scattered);
    ...
    private void initView() {
        ...
        adapter = new ArrayAdapter<String>(InventoryTaskCreateManualWholeAndScatteredActivity.this, android.R.layout.simple_list_item_1, strList);
    ...
    {
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.InventoryTaskCreateManualWholeAndScattered(), RequestMethod.POST);
        SENDSMSRequest.addHeader("token", "79FAF822-7194-4FE3-8C4F-1D99BE71BC9C");
        SENDSMSRequest.add("sEcho", "1");
        CallServer.getInstance().add(InventoryTaskCreateManualWholeAndScatteredActivity.this, 1000, SENDSMSRequest, new HttpListener<String>() {
            @Override

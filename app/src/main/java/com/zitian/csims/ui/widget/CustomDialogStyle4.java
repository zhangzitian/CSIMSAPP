...
public class CustomDialogStyle4 extends Dialog {

    public CustomDialogStyle4(Context context) {
        super(context);
    }

    public CustomDialogStyle4(Context context, int themeResId) {
        super(context, themeResId);
    }

    protected CustomDialogStyle4(Context context, boolean cancelable, DialogInterface.OnCancelListener cancelListener) {
    ...
    public static class Builder {
        ...
        public CustomDialogStyle4.Builder setTitle(String title) {
            if (title == null) {
                this.title = "提醒";
            }
            this.title = title;
        ...
        public CustomDialogStyle4.Builder setProdNo(String prodNoStr) {
            //if (prodNoStr == null) {
            //    this.prodNoStr = "";
            //}
        ...
        public CustomDialogStyle4.Builder setProdName(String prodNameStr) {
            //if (prodNameStr == null) {
            //    this.prodNameStr = "提醒";
            //}
        ...
        public CustomDialogStyle4.Builder setNbook_num(String nbook_numStr) {
        ...
        public CustomDialogStyle4.Builder setNegativeButton(String negative_text, DialogInterface.OnClickListener negativeListener) {
        ...
        public CustomDialogStyle4.Builder setPositionButton(String positive_text, DialogInterface.OnClickListener positiveListener) {
        ...
        public CustomDialogStyle4 create() {
            final CustomDialogStyle4 dialog = new CustomDialogStyle4(context);
            View view = LayoutInflater.from(context).inflate(R.layout.dialog_style_layout4, null);

...
public class BookrevisionManagerAddActivity  extends BaseActivity implements  View.OnClickListener, HttpListener<String> {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.bt01:
                ...
                }else if(mDataAdapter.getDataList().size()==0)
                {
                    Alert("提示","库存暂无此书无法下架","知道了");
                }else
                    DataBind2(true);
    ...
    {
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.BookrevisionManagerAdd(), RequestMethod.POST);
    ...
    {
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.BookrevisionManagerAdd2(), RequestMethod.POST);
        SENDSMSRequest.addHeader("token", "79FAF822-7194-4FE3-8C4F-1D99BE71BC9C");
        SENDSMSRequest.add("sEcho", "1");
        SENDSMSRequest.add("prodNo",search_edit.getText().toString());

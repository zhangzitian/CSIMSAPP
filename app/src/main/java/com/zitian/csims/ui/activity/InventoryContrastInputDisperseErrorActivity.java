...
public class InventoryContrastInputDisperseErrorActivity extends BaseActivity implements  View.OnClickListener, HttpListener<String> {
    ...
    private void DataBind2(boolean isLoading) {
        Gson gson = new Gson();
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.InventoryContrastInputDisperseError(), RequestMethod.POST);
    ...
    private void DataBind3(boolean isLoading) {
        Gson gson = new Gson();
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.GetContrastInventoryDataAndManualScatteredError(), RequestMethod.POST);
        SENDSMSRequest.addHeader("token", "79FAF822-7194-4FE3-8C4F-1D99BE71BC9C");
        SENDSMSRequest.add("sEcho", "1");
        SENDSMSRequest.add("UserName", CSIMSApplication.getAppContext().getUser().getO_name());
        SENDSMSRequest.add("UserId", CSIMSApplication.getAppContext().getUser().getO_id());
    ...
    {
        builder = new CustomDialogStyle3.Builder(InventoryContrastInputDisperseErrorActivity.this);
        builder.setTitle("库位号:"+itemModel.getWh_wareHouseNo())
                ...
                .setPositionButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        {
                            Toast.makeText(InventoryContrastInputDisperseErrorActivity.this,"产品编码不能为空！",Toast.LENGTH_SHORT).show();
                            return;
                        }

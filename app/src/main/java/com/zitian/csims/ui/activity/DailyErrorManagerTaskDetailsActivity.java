...
public class DailyErrorManagerTaskDetailsActivity  extends BaseActivity implements  View.OnClickListener, HttpListener<String> {

   private ImageView icon_back;
    DailyErrorManagerTaskList.Bean itemModel = null;


    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_daily_error_manager_task_details);
        ...
        itemModel = (DailyErrorManagerTaskList.Bean) bundle.get("itemModel");
    ...
    private void initView() {
        ...
        mDataAdapter = new DailyErrorManagerTaskDetailsAdapter(this);
    ...
    private DailyErrorManagerTaskDetailsAdapter mDataAdapter = null;
    ...
    {
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.DailyErrorManagerTaskDetails(), RequestMethod.POST);
        ...
        SENDSMSRequest.add("d_prodNo", itemModel.getD_prodNo());
        SENDSMSRequest.add("d_Type", itemModel.getD_Type());
    ...
    private void addItems(List<DailyErrorManagerTaskDetails.Bean> list) {
    ...
    public void onSucceed(int what, Response<String> response) {
        ...
        switch (what) {
            case 1000://快速登录
                DailyErrorManagerTaskDetails outofSpaceForkliftList = gson.fromJson(response.get(), DailyErrorManagerTaskDetails.class);
     ...
     * item＋item里的控件点击监听事件
     */
    private DailyErrorManagerTaskDetailsAdapter.OnItemClickListener MyItemClickListener = new DailyErrorManagerTaskDetailsAdapter.OnItemClickListener() {
        @Override
        public void onItemClick(View v, DailyErrorManagerTaskDetailsAdapter.ViewName viewName, int position) {
            //viewName可区分item及item内部控件
            switch (v.getId()){
                case R.id.tv_fromNoAndArea:
                    DailyErrorManagerTaskDetails.Bean itemModel = mDataAdapter.getDataList().get(position);

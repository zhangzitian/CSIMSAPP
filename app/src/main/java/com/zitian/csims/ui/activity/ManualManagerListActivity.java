...
public class ManualManagerListActivity  extends BaseActivity implements  View.OnClickListener, HttpListener<String> {

    private ImageView icon_back;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_manual_manager_list);
    ...
    private void initView() {
        ...
        mDataAdapter = new ManualManagerListAdapter(this);
    ...
    private ManualManagerListAdapter mDataAdapter = null;
    ...
    private void DataBind(boolean isLoading)
    {
        ...
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.ManualManagerList(), RequestMethod.POST);
    ...
    private void addItems(List<ManualManagerList.Bean> list) {
    ...
    public void onSucceed(int what, Response<String> response) {
        ...
        switch (what) {
            case 1000:
                ManualManagerList outofSpaceForkliftList = gson.fromJson(response.get(), ManualManagerList.class);
                ...
                break;
            case 1001:
                outofSpaceForkliftList = gson.fromJson(response.get(), ManualManagerList.class);
                if (outofSpaceForkliftList.getResult() == 1) {
     ...
     * item＋item里的控件点击监听事件
     */
    private ManualManagerListAdapter.OnItemClickListener MyItemClickListener = new ManualManagerListAdapter.OnItemClickListener() {
        @Override
        public void onItemClick(View v, ManualManagerListAdapter.ViewName viewName, int position) {
            //viewName可区分item及item内部控件
            switch (v.getId()){
                case R.id.tv_fromNoAndArea:
                    ManualManagerList.Bean itemModel = mDataAdapter.getDataList().get(position);
                ...
                case R.id.btnOperation:
                    ...
                    Intent intent = new Intent(ManualManagerListActivity.this,ManualManagerExamineActivity.class);

...
public class InventoryInputWholeErrorAdapter extends ListBaseAdapter<InventoryInputWholeError.Bean>  implements View.OnClickListener{

    public InventoryInputWholeErrorAdapter(Context context) {
        super(context);
    }
    ...
    public void onBindItemHolder(SuperViewHolder holder, int position) {
        InventoryInputWholeError.Bean item = mDataList.get(position);
        ...
        btnGain.setOnClickListener(InventoryInputWholeErrorAdapter.this);
        btnOperation.setOnClickListener(InventoryInputWholeErrorAdapter.this);
...
//        }
    ...
    public interface OnItemClickListener  {
        void onItemClick(View v, InventoryInputWholeErrorAdapter.ViewName viewName, int position);
        void onItemLongClick(View v);
    }
    private InventoryInputWholeErrorAdapter.OnItemClickListener mOnItemClickListener;//声明自定义的接口
    //定义方法并传给外面的使用者
    public void setOnItemClickListener(InventoryInputWholeErrorAdapter.OnItemClickListener listener) {
    ...
    public void onClick(View v) {
        ...
        if (mOnItemClickListener != null) {
            switch (v.getId()){
                default:
                    mOnItemClickListener.onItemClick(v, InventoryInputWholeErrorAdapter.ViewName.ITEM, position);
                    break;
            }
        }
    }

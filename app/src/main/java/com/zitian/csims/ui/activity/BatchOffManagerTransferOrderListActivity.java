...
import com.zitian.csims.ui.adapter.BatchOffManagerTransferOrderListAdapter;
...
public class BatchOffManagerTransferOrderListActivity  extends BaseActivity implements  View.OnClickListener, HttpListener<String> {

    private ImageView icon_back;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_batch_off_manager_transfer_order_list);
    ...
    private void initView() {
        ...
        mDataAdapter = new BatchOffManagerTransferOrderListAdapter(this);
        ...
        mLRecyclerViewAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                if (mDataAdapter.getDataList().size() > position) {
                    BatchOffManagerTransferOrderList.Bean item = mDataAdapter.getDataList().get(position);
    ...
    private BatchOffManagerTransferOrderListAdapter mDataAdapter = null;
    ...
    {
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.BatchOffManagerTransferOrderList(), RequestMethod.POST);
    ...
    private void addItems(List<BatchOffManagerTransferOrderList.Bean> list) {
    ...
    public void onSucceed(int what, Response<String> response) {
        ...
        switch (what) {
            case 1000://快速登录
                BatchOffManagerTransferOrderList outofSpaceForkliftList = gson.fromJson(response.get(), BatchOffManagerTransferOrderList.class);
                if (outofSpaceForkliftList.getResult() == 1) {
                    if (outofSpaceForkliftList.getData() != null) {
                        ...
                        mRecyclerView.refreshComplete(REQUEST_COUNT);
                    } else if (outofSpaceForkliftList.getResult() == 1) {
                    } else {
                    }
                    break;
                }
     ...
     * item＋item里的控件点击监听事件
     */
    private BatchOffManagerTransferOrderListAdapter.OnItemClickListener MyItemClickListener = new BatchOffManagerTransferOrderListAdapter.OnItemClickListener() {

        @Override
        public void onItemClick(View v, BatchOffManagerTransferOrderListAdapter.ViewName viewName, int position) {
            //viewName可区分item及item内部控件
            switch (v.getId()){
//                case R.id.tv_fromNoAndArea:
//                    BatchOffManagerTransferOrderList.Bean itemModel = mDataAdapter.getDataList().get(position);
...
//                    break;
                case R.id.btnOperation:
                    ...
                    //mBundle.putSerializable("itemModel",itemModel);
                    //mBundle.putInt("mType",1);
                    //openActivity(BatchOffManagerTransferOrderAddActivity.class,mBundle);
                    Intent intent = new Intent(BatchOffManagerTransferOrderListActivity.this,BatchOffManagerTransferOrderAddActivity.class);

...
public class InventoryManualAddItemListAdapter extends ListBaseAdapter<InventoryManualAddItemList.Bean>  implements View.OnClickListener{

    public InventoryManualAddItemListAdapter(Context context) {
        super(context);
    }

    @Override
    public int getLayoutId() {
        return R.layout.activity_inventory_manual_add_item_list_item;
    }

    @Override
    public void onBindItemHolder(SuperViewHolder holder, int position) {
        InventoryManualAddItemList.Bean item = mDataList.get(position);
        ...
        btnGain.setOnClickListener(InventoryManualAddItemListAdapter.this);
        btnOperation.setOnClickListener(InventoryManualAddItemListAdapter.this);
    ...
    public interface OnItemClickListener  {
        void onItemClick(View v, InventoryManualAddItemListAdapter.ViewName viewName, int position);
        void onItemLongClick(View v);
    }
    private InventoryManualAddItemListAdapter.OnItemClickListener mOnItemClickListener;//声明自定义的接口
    //定义方法并传给外面的使用者
    public void setOnItemClickListener(InventoryManualAddItemListAdapter.OnItemClickListener listener) {
    ...
    public void onClick(View v) {
        ...
        if (mOnItemClickListener != null) {
            switch (v.getId()){
                default:
                    mOnItemClickListener.onItemClick(v, InventoryManualAddItemListAdapter.ViewName.ITEM, position);
                    break;
            }
        }
    }

...
public class InventoryActivity  extends BaseActivity implements  View.OnClickListener, HttpListener<String> {
    ...
    {
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.Inventory2(), RequestMethod.POST);
        SENDSMSRequest.addHeader("token", "79FAF822-7194-4FE3-8C4F-1D99BE71BC9C");
        SENDSMSRequest.add("sEcho", "1");
        CallServer.getInstance().add(this, 1000, SENDSMSRequest, this, false, isLoading);
    }
    ...
    {
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.Inventory3(), RequestMethod.POST);
        SENDSMSRequest.addHeader("token", "79FAF822-7194-4FE3-8C4F-1D99BE71BC9C");
        SENDSMSRequest.add("sEcho", "1");
        CallServer.getInstance().add(this, 1000, SENDSMSRequest, this, false, isLoading);
    }

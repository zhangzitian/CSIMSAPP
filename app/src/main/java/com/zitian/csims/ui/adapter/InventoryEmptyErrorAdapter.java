...
public class InventoryEmptyErrorAdapter extends ListBaseAdapter<InventoryEmptyError.Bean>  implements View.OnClickListener{

    public InventoryEmptyErrorAdapter(Context context) {
        super(context);
    }

    @Override
    public int getLayoutId() {
        return R.layout.activity_inventory_empty_error_item;
    }

    @Override
    public void onBindItemHolder(SuperViewHolder holder, int position) {
        InventoryEmptyError.Bean item = mDataList.get(position);
        ...
        //title3.setOnClickListener(InventoryEmptyErrorAdapter.this);
        ...
        btnGain.setOnClickListener(InventoryEmptyErrorAdapter.this);
        btnOperation.setOnClickListener(InventoryEmptyErrorAdapter.this);
...
//        }
    ...
    public interface OnItemClickListener  {
        void onItemClick(View v, InventoryEmptyErrorAdapter.ViewName viewName, int position);
        void onItemLongClick(View v);
    }
    private InventoryEmptyErrorAdapter.OnItemClickListener mOnItemClickListener;//声明自定义的接口
    //定义方法并传给外面的使用者
    public void setOnItemClickListener(InventoryEmptyErrorAdapter.OnItemClickListener listener) {
    ...
    public void onClick(View v) {
        ...
        if (mOnItemClickListener != null) {
            switch (v.getId()){
                default:
                    mOnItemClickListener.onItemClick(v, InventoryEmptyErrorAdapter.ViewName.ITEM, position);
                    break;
            }
        }
    }

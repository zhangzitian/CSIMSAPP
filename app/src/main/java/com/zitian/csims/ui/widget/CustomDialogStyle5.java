...
public class CustomDialogStyle5  extends Dialog {

    public CustomDialogStyle5(Context context) {
        super(context);
    }

    public CustomDialogStyle5(Context context, int themeResId) {
        super(context, themeResId);
    }

    protected CustomDialogStyle5(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    public static class Builder {
        ...
        public CustomDialogStyle5.Builder setTitle(String title) {
            if (title == null) {
                this.title = "提醒";
            }
            this.title = title;
        ...
        public CustomDialogStyle5.Builder setMessage(String message) {
            if (message == null) {
        ...
        public CustomDialogStyle5.Builder setNegativeButton(String negative_text, DialogInterface.OnClickListener negativeListener) {
        ...
        public CustomDialogStyle5.Builder setPositionButton(String positive_text, DialogInterface.OnClickListener positiveListener) {
        ...
        public CheckBox cb_message_one_dialog;
        public CheckBox cb_message_two_dialog;
        public CheckBox cb_message_three_dialog;
        public CheckBox cb_message_four_dialog;

        private Button btn_negative_custom_dialog;//消极
        private Button btn_positive_custom_dialog;//积极


        public CustomDialogStyle2 create() {
            final CustomDialogStyle2 dialog = new CustomDialogStyle2(context);
            View view = LayoutInflater.from(context).inflate(R.layout.dialog_style_layout5, null);
...
//            dialog.addContentView(view, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
            ...
            cb_message_one_dialog = (CheckBox) view.findViewById(R.id.cb_one);
            cb_message_two_dialog = (CheckBox) view.findViewById(R.id.cb_two);
            cb_message_three_dialog = (CheckBox) view.findViewById(R.id.cb_three);
            cb_message_four_dialog = (CheckBox) view.findViewById(R.id.cb_four);

...
public class WarehousingErrorManagerListActivity  extends BaseActivity implements  View.OnClickListener, HttpListener<String> {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_warehousing_error_manager_list);
        mCurrentPage = 0;
        initView();
        setViewListener();
        DataBind(true);
    ...
    private void initView() {
        ...
        mDataAdapter = new WarehousingErrorManagerListAdapter(this);
        ...
        mLRecyclerViewAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                if (mDataAdapter.getDataList().size() > position) {
                    WarehousingErrorManagerList.Bean item = mDataAdapter.getDataList().get(position);
    ...
    private WarehousingErrorManagerListAdapter mDataAdapter = null;
    ...
    private void DataBind(boolean isLoading) {
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.WarehousingErrorManagerList(), RequestMethod.POST);
        ...
        SENDSMSRequest.add("condition", "e_state='未审核'");
    ...
    private void addItems(List<WarehousingErrorManagerList.Bean> list) {
     ...
     * item＋item里的控件点击监听事件
     */
    private WarehousingErrorManagerListAdapter.OnItemClickListener MyItemClickListener = new WarehousingErrorManagerListAdapter.OnItemClickListener() {

        @Override
        public void onItemClick(View v, WarehousingErrorManagerListAdapter.ViewName viewName, int position) {
            //viewName可区分item及item内部控件
            switch (v.getId()) {
                case R.id.tv_fromNoAndArea:
                    WarehousingErrorManagerList.Bean itemModel = mDataAdapter.getDataList().get(position);
                ...
                case R.id.btnOperation:
                    ...
                    Intent intent = new Intent(WarehousingErrorManagerListActivity.this,WarehousingErrorManagerExamineActivity.class);

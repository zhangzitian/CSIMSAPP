...
public class BookrevisionManagerListActivity  extends BaseActivity implements  View.OnClickListener, HttpListener<String> {

    private ImageView icon_back;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bookrevision_manager_list);
    ...
    private void initView() {
        ...
        mDataAdapter = new BookrevisionManagerListAdapter(this);
    ...
    private BookrevisionManagerListAdapter mDataAdapter = null;
    ...
    {
        String condition =  "[t_taskType] = '图书改版下架' and t_taskState = '已领取' ";
        //if(!search_edit.getText().toString().equals("") )
        //{
        //    String prodNo = search_edit.getText().toString();
        //    condition += " and [t_prodNo] =  '" + prodNo + "'";
        //}
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.BookrevisionManagerList(), RequestMethod.POST);
    ...
    private void DataBind2(int id,String wh_wareHouseNo,boolean isLoading) {
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.BookrevisionManagerList2(), RequestMethod.POST);
        SENDSMSRequest.addHeader("token", "79FAF822-7194-4FE3-8C4F-1D99BE71BC9C");
        SENDSMSRequest.add("wh_wareHouseNo", wh_wareHouseNo);
    ...
    private void addItems(List<BookrevisionManagerList.Bean> list) {
    ...
    public void onSucceed(int what, Response<String> response) {
        ...
        switch (what) {
            case 1000://快速登录
                BookrevisionManagerList outofSpaceForkliftList = gson.fromJson(response.get(), BookrevisionManagerList.class);
                ...
                break;
            case 1001://快速登录
                outofSpaceForkliftList = gson.fromJson(response.get(), BookrevisionManagerList.class);
                if (outofSpaceForkliftList.getResult() == 1) {
     ...
     * item＋item里的控件点击监听事件
     */
    private BookrevisionManagerListAdapter.OnItemClickListener MyItemClickListener = new BookrevisionManagerListAdapter.OnItemClickListener() {

        @Override
        public void onItemClick(View v, BookrevisionManagerListAdapter.ViewName viewName, int position) {

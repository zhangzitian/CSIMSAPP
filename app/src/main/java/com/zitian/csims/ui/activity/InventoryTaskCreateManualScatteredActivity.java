...
public class InventoryTaskCreateManualScatteredActivity extends BaseActivity implements  View.OnClickListener, HttpListener<String> {
    ...
    private void initView() {
        ...
        adapter = new ArrayAdapter<String>(InventoryTaskCreateManualScatteredActivity.this, android.R.layout.simple_list_item_1, strList);
    ...
    {
        Request<String> SENDSMSRequest = NoHttp.createStringRequest(AppConstant.InventoryTaskCreateManualScattered(), RequestMethod.POST);
        SENDSMSRequest.addHeader("token", "79FAF822-7194-4FE3-8C4F-1D99BE71BC9C");
        SENDSMSRequest.add("sEcho", "1");
        CallServer.getInstance().add(InventoryTaskCreateManualScatteredActivity.this, 1000, SENDSMSRequest, new HttpListener<String>() {
            @Override

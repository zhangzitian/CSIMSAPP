...
public class BookrevisionManagerAdd {
    private int result;
    private String msg;
    private List<BookrevisionManagerAdd.Bean> data;
    private int total;
    ...
    public List<BookrevisionManagerAdd.Bean> getData() {
        return data;
    }
    public void setData(List<BookrevisionManagerAdd.Bean> data) {
        this.data = data;
    }

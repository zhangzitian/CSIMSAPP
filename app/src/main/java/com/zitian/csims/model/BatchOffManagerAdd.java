...
public class BatchOffManagerAdd {
    private int result;
    private String msg;
    private List<BatchOffManagerAdd.Bean> data;
    private int total;
    ...
    public List<BatchOffManagerAdd.Bean> getData() {
        return data;
    }
    public void setData(List<BatchOffManagerAdd.Bean> data) {
        this.data = data;
    }

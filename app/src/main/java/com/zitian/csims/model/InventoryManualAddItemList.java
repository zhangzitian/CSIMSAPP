...
public class InventoryManualAddItemList {
    private int result;
    private String msg;
    private List<InventoryManualAddItemList.Bean> data;
    private int total;
    ...
    public List<InventoryManualAddItemList.Bean> getData() {
        return data;
    }
    public void setData(List<InventoryManualAddItemList.Bean> data) {
        this.data = data;
    }

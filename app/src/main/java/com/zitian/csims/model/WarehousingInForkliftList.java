...
public class WarehousingInForkliftList {
    private int result;
    private String msg;
    private List<WarehousingInForkliftList.Bean> data;
    private int total;
    ...
    public List<WarehousingInForkliftList.Bean> getData() {
        return data;
    }
    public void setData(List<WarehousingInForkliftList.Bean> data) {
        this.data = data;
    }

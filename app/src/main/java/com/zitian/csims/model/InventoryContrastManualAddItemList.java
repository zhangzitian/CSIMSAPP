...
public class InventoryContrastManualAddItemList {
    private int result;
    private String msg;
    private List<InventoryContrastManualAddItemList.Bean> data;
    private int total;
    ...
    public List<InventoryContrastManualAddItemList.Bean> getData() {
        return data;
    }
    public void setData(List<InventoryContrastManualAddItemList.Bean> data) {
        this.data = data;
    }

...
public class WarehousingInManagerTaskList {
    private int result;
    private String msg;
    private List<WarehousingInManagerTaskList.Bean> data;
    private int total;
    ...
    public List<WarehousingInManagerTaskList.Bean> getData() {
        return data;
    }
    public void setData(List<WarehousingInManagerTaskList.Bean> data) {
        this.data = data;
    }

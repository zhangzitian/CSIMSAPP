...
public class InventoryNuclearDiskList2 {
    private int result;
    private String msg;
    private InventoryNuclearDiskList.Bean data;
    private int total;
    ...
    public InventoryNuclearDiskList.Bean getData() {
        return data;
    }
    public void setData(InventoryNuclearDiskList.Bean data) {
        this.data = data;
    }

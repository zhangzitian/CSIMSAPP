...
public class DailyErrorForkliftWarehousingTaskList {
    private int result;
    private String msg;
    private List<DailyErrorForkliftWarehousingTaskList.Bean> data;
    private int total;
    ...
    public List<DailyErrorForkliftWarehousingTaskList.Bean> getData() {
        return data;
    }
    public void setData(List<DailyErrorForkliftWarehousingTaskList.Bean> data) {
        this.data = data;
    }

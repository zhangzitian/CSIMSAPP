...
public class InventoryErrorList {
    private int result;
    private String msg;
    private List<InventoryErrorList.Bean> data;
    private int total;
    ...
    public List<InventoryErrorList.Bean> getData() {
        return data;
    }
    public void setData(List<InventoryErrorList.Bean> data) {
        this.data = data;
    }

...
public class BatchOffManagerManualAdd {
    private int result;
    private String msg;
    private List<BatchOffManagerManualAdd.Bean> data;
    private int total;
    ...
    public List<BatchOffManagerManualAdd.Bean> getData() {
        return data;
    }
    public void setData(List<BatchOffManagerManualAdd.Bean> data) {
        this.data = data;
    }

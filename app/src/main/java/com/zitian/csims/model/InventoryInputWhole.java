...
public class InventoryInputWhole {
    private int result;
    private String msg;
    private InventoryInputWhole.Bean data;
    private int total;
    ...
    public InventoryInputWhole.Bean getData() {
        return data;
    }
    public void setData(InventoryInputWhole.Bean data) {
        this.data = data;
    }

...
public class BatchOffManagerList {
    private int result;
    private String msg;
    private List<BatchOffManagerList.Bean> data;
    private int total;
    ...
    public List<BatchOffManagerList.Bean> getData() {
        return data;
    }
    public void setData(List<BatchOffManagerList.Bean> data) {
        this.data = data;
    }

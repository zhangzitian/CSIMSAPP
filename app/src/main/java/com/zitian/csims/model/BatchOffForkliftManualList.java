...
public class BatchOffForkliftManualList {
    private int result;
    private String msg;
    private List<BatchOffForkliftManualList.Bean> data;
    private int total;
    ...
    public List<BatchOffForkliftManualList.Bean> getData() {
        return data;
    }
    public void setData(List<BatchOffForkliftManualList.Bean> data) {
        this.data = data;
    }

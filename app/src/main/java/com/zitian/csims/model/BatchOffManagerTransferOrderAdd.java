...
public class BatchOffManagerTransferOrderAdd {
    private int result;
    private String msg;
    private List<BatchOffManagerTransferOrderAdd.Bean> data;
    private int total;
    ...
    public List<BatchOffManagerTransferOrderAdd.Bean> getData() {
        return data;
    }
    public void setData(List<BatchOffManagerTransferOrderAdd.Bean> data) {
        this.data = data;
    }

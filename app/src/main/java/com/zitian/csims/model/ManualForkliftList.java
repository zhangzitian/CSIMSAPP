...
public class ManualForkliftList {
    private int result;
    private String msg;
    private List<ManualForkliftList.Bean> data;
    private int total;
    ...
    public List<ManualForkliftList.Bean> getData() {
        return data;
    }
    public void setData(List<ManualForkliftList.Bean> data) {
        this.data = data;
    }

...
public class InventoryInputDisperseError {
    private int result;
    private String msg;
    private List<InventoryInputDisperseError.Bean> data;
    private int total;
    ...
    public List<InventoryInputDisperseError.Bean> getData() {
        return data;
    }
    public void setData(List<InventoryInputDisperseError.Bean> data) {
        this.data = data;
    }

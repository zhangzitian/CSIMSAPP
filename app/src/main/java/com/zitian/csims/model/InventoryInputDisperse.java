...
public class InventoryInputDisperse {
    private int result;
    private String msg;
    private InventoryInputDisperse.Bean data;
    private int total;
    ...
    public InventoryInputDisperse.Bean getData() {
        return data;
    }
    public void setData(InventoryInputDisperse.Bean data) {
        this.data = data;
    }

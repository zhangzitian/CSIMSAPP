...
public class WarehousingInDistributionFullTask2 {
    private int result;
    private String msg;
    private WarehousingInDistributionFullTask2.Bean data;
    private int total;
    ...
    public WarehousingInDistributionFullTask2.Bean getData() {
        return data;
    }
    public void setData(WarehousingInDistributionFullTask2.Bean data) {
        this.data = data;
    }

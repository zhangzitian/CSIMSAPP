...
public class InventoryManualList {
    private int result;
    private String msg;
    private List<InventoryManualList.Bean> data;
    private int total;
    ...
    public List<InventoryManualList.Bean> getData() {
        return data;
    }
    public void setData(List<InventoryManualList.Bean> data) {
        this.data = data;
    }
    ...
    public static class Bean  implements Serializable {
        ...
        private boolean hasChecked; //是否选中

...
public class ReplenishAutoDistributionList {
    private int result;
    private String msg;
    private List<ReplenishAutoDistributionList.Bean> data;
    private int total;
    ...
    public List<ReplenishAutoDistributionList.Bean> getData() {
        return data;
    }
    public void setData(List<ReplenishAutoDistributionList.Bean> data) {
        this.data = data;
    }

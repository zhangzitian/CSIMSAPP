...
public class BookrevisionManagerList {
    private int result;
    private String msg;
    private List<BookrevisionManagerList.Bean> data;
    private int total;
    ...
    public List<BookrevisionManagerList.Bean> getData() {
        return data;
    }
    public void setData(List<BookrevisionManagerList.Bean> data) {
        this.data = data;
    }

...
public class BatchOffForkliftList {
    private int result;
    private String msg;
    private List<BatchOffForkliftList.Bean> data;
    private int total;
    ...
    public List<BatchOffForkliftList.Bean> getData() {
        return data;
    }
    public void setData(List<BatchOffForkliftList.Bean> data) {
        this.data = data;
    }

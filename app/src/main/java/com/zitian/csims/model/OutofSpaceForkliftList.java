...
public class OutofSpaceForkliftList {

    private int result;
    private String msg;
    private List<OutofSpaceForkliftList.Bean> data;
    private int total;
    ...
    public List<OutofSpaceForkliftList.Bean> getData() {
        return data;
    }
    public void setData(List<OutofSpaceForkliftList.Bean> data) {
        this.data = data;
    }

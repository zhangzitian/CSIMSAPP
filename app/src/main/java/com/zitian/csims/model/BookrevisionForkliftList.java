...
public class BookrevisionForkliftList {
    private int result;
    private String msg;
    private List<BookrevisionForkliftList.Bean> data;
    private int total;
    ...
    public List<BookrevisionForkliftList.Bean> getData() {
        return data;
    }
    public void setData(List<BookrevisionForkliftList.Bean> data) {
        this.data = data;
    }

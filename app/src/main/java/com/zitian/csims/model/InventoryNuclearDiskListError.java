...
public class InventoryNuclearDiskListError {
    private int result;
    private String msg;
    private List<InventoryNuclearDiskListError.Bean> data;
    private int total;
    ...
    public List<InventoryNuclearDiskListError.Bean> getData() {
        return data;
    }
    public void setData(List<InventoryNuclearDiskListError.Bean> data) {
        this.data = data;
    }

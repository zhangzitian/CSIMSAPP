...
public class WarehousingErrorForkliftDistributionList {
    private int result;
    private String msg;
    private List<WarehousingErrorForkliftDistributionList.Bean> data;
    private int total;
    ...
    public List<WarehousingErrorForkliftDistributionList.Bean> getData() {
        return data;
    }
    public void setData(List<WarehousingErrorForkliftDistributionList.Bean> data) {
        this.data = data;
    }
    ...
    public static class Bean  implements Serializable {
        ...
        public String getE_sourceType() {
            return e_sourceType;
        }

        public void setE_sourceType(String e_sourceType) {
            this.e_sourceType = e_sourceType;
        }

        private String e_sourceType;

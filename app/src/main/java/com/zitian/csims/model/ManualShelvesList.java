...
public class ManualShelvesList {

    private int result;
    private String msg;
    private List<ManualShelvesList.Bean> data;
    private int total;
    ...
    public List<ManualShelvesList.Bean> getData() {
        return data;
    }
    public void setData(List<ManualShelvesList.Bean> data) {
        this.data = data;
    }

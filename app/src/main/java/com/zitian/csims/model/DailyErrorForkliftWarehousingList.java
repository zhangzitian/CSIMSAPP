...
public class DailyErrorForkliftWarehousingList {
    private int result;
    private String msg;
    private List<DailyErrorForkliftWarehousingList.Bean> data;
    private int total;
    ...
    public List<DailyErrorForkliftWarehousingList.Bean> getData() {
        return data;
    }
    public void setData(List<DailyErrorForkliftWarehousingList.Bean> data) {
        this.data = data;
    }

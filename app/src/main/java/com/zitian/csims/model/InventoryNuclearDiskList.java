...
public class InventoryNuclearDiskList {
    private int result;
    private String msg;
    private List<InventoryNuclearDiskList.Bean> data;
    private int total;
    ...
    public List<InventoryNuclearDiskList.Bean> getData() {
        return data;
    }
    public void setData(List<InventoryNuclearDiskList.Bean> data) {
        this.data = data;
    }

...
public class InventoryInputWholeError {
    private int result;
    private String msg;
    private List<InventoryInputWholeError.Bean> data;
    private int total;
    ...
    public List<InventoryInputWholeError.Bean> getData() {
        return data;
    }
    public void setData(List<InventoryInputWholeError.Bean> data) {
        this.data = data;
    }

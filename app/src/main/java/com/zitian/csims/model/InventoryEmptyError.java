...
public class InventoryEmptyError {
    private int result;
    private String msg;
    private InventoryEmptyError.Bean data;
    private int total;
    ...
    public InventoryEmptyError.Bean getData() {
        return data;
    }
    public void setData(InventoryEmptyError.Bean data) {
        this.data = data;
    }

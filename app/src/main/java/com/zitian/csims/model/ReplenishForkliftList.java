...
public class ReplenishForkliftList {
    private int result;
    private String msg;
    private List<ReplenishForkliftList.Bean> data;
    private int total;
    ...
    public List<ReplenishForkliftList.Bean> getData() {
        return data;
    }
    public void setData(List<ReplenishForkliftList.Bean> data) {
        this.data = data;
    }
